...
var barcode=angular.module('app', ['ionic','ngCordova', 'app.controllers', 'app.routes', 'app.directives','app.services'])
...
.run(function($ionicPlatform) {
  $ionicPlatform.ready(function() {
    ...
    if (window.StatusBar) {
      ...
      var utterance = new SpeechSynthesisUtterance("hi this is assignment 7");
...
//unit testing karma
barcode.controller('PasswordController', function PasswordController($scope) {
  $scope.password = '';
